...
#  The (0, 0) origin is in the upper-left corner, the x-coordinates increase going right,
...
#  then grid[2][0], and so on, up to grid[8][0]. This will finish the first row, so then print a newline.
