...
#  and the second part checks if there is a streak of six in it.

#  Put all of this code in a loop that repeats the experiment 10,000 times so
...
#  Some knowledge of mathematics could give you the exact answer
#  and save you the trouble of writing a program, but programmers are notoriously bad at math.
...
for experimentNumber in range(10000):
    #  Gera uma lista com 100 H or T:
    headsOrTails = []
    while len(headsOrTails) <= 100:
...
#  print(headsOrTails)
print('Head Streaks: ' + str(numberOfHeadStreaks))
print('Tail Streaks: ' + str(numberOfTailStreaks))
print('Ambos: ' + str(numberOfStreaks))
print('Chance of streak (errado será? nao consegui conferir): %s%%' % (numberOfStreaks / (100 * 10000)))
